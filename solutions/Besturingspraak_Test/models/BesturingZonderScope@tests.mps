...
<model ref="r:f27a4ffe-4eca-4afe-9ff0-e6ffe28c3869(Besturingspraak_Test.BesturingZonderScope@tests)">
  ...
  <registry>
    ...
    <language id="65239ca4-9057-41f8-999d-97fa1a60b298" name="besturingspraak">
      <concept id="9154144551726427366" name="besturingspraak.structure.FlowVersie" flags="ng" index="1Fci4u">
        <property id="9154144551731005409" name="bronvermelding" index="1FyKCp" />
  ...
  <node concept="LiM7Y" id="1LKisCcrQia">
    <property role="TrG5h" value="FlowZonderScope" />
    <node concept="3clFbS" id="1LKisCcs8Bu" role="LjaKd">
      <node concept="2HxZob" id="3iXjfRQrpc1" role="3cqZAp">
        <node concept="1iFQzN" id="3iXjfRQrpeo" role="3iKnsn">
          <ref role="1iFR8X" to="ekwn:2XByp9s_j7f" resolve="Complete" />
        </node>
      </node>
      <node concept="3vlDli" id="11sJ8JuEHyI" role="3cqZAp">
        <node concept="3cmrfG" id="11sJ8JuEKjS" role="3tpDZB">
          <property role="3cmrfH" value="0" />
        </node>
        <node concept="2OqwBi" id="11sJ8JuEJKF" role="3tpDZA">
          <node concept="2OqwBi" id="11sJ8JuEHTA" role="2Oq$k0">
            <node concept="369mXd" id="11sJ8JuEHC2" role="2Oq$k0" />
            <node concept="liA8E" id="11sJ8JuEJF_" role="2OqNvi">
              <ref role="37wK5l" to="exr9:~EditorComponent.getNodeSubstituteChooser()" resolve="getNodeSubstituteChooser" />
            </node>
          </node>
          <node concept="liA8E" id="11sJ8JuEK8K" role="2OqNvi">
            <ref role="37wK5l" to="6lvu:~NodeSubstituteChooser.getNumberOfActions()" resolve="getNumberOfActions" />
          </node>
        </node>
      </node>
    </node>
    <node concept="1qefOq" id="4WetKT2PDhU" role="25YQCW">
      <node concept="3MLgNT" id="1LKisCcrQib" role="1qenE9">
        <property role="TrG5h" value="FlowZonderScope" />
        <node concept="1Fci4u" id="1LKisCcrQic" role="1Fci2$">
          <property role="1FyKCp" value="http://example.org" />
          <node concept="3MLD7v" id="1LKisCcrQid" role="1Fci2p" />
          <node concept="2ljwA5" id="1LKisCcrQie" role="2DzjYZ" />
        </node>
        <node concept="LIFWc" id="11sJ8JuEFAe" role="lGtFl">
