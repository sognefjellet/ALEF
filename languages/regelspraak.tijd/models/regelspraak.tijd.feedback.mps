...
<model ref="r:e41b9b97-c439-4ac7-964f-cd9cd507a2d8(regelspraak.tijd.feedback)">
  ...
  <node concept="3QByoM" id="1bBCVu$Yc36">
    <property role="TrG5h" value="???_Feedtback" />
    <ref role="3Z9TSV" to="4udd:3SYd9_wAuQj" resolve="StartpuntBepaling" />
    <node concept="3QByp$" id="1bBCVu$Yeut" role="3QBEN7">
      <node concept="16I2mz" id="1bBCVu$Yeuu" role="16N$OO">
        <node concept="16N$OT" id="1bBCVu$Yeuv" role="16I2mt">
          <property role="16N$OU" value="Kan alleen voor tijdlijnen met een variabel startpunt het startpunt bepalen" />
        </node>
      </node>
      <node concept="216oCf" id="1bBCVu$Yeuo" role="3JXyrO">
        <ref role="sa$J1" to="bea4:1mFJTG7e$j" resolve="RefOutOfScope" />
        <ref role="216p6q" to="4udd:3SYd9_wAuQk" resolve="tijdlijn" />
      </node>
    </node>
  </node>
</model>
