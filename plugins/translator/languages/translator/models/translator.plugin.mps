...
<model ref="r:7ed5b4f2-027c-4924-9382-b7694dee9e3c(translator.plugin)">
  ...
  <node concept="3vrhyV" id="1usUWAdv6$5">
    <property role="TrG5h" value="translator" />
    <node concept="2V$Bhx" id="1usUWAdv6$7" role="QG$2i">
      <property role="2V$B1T" value="bef79dc4-9060-4318-a10a-46eb2fa0f3b1" />
      <property role="2V$B1Q" value="translator" />
    </node>
    <node concept="2vPdvu" id="1usUWAdv6$9" role="3F_NFc">
      <node concept="1SjbrP" id="1usUWAdv6GM" role="2vPdvg">
        <ref role="2vPdvl" to="f7uj:2LiUEk8oQ$g" resolve="typesystem" />
      </node>
      <node concept="1SjbrP" id="1usUWAdv6$d" role="2vPdvg">
        <ref role="2vPdvl" node="1usUWAdv6$5" resolve="translator" />
      </node>
    </node>
    <node concept="T9mpH" id="IRFRBS2iHq" role="TkT64">
      <property role="T9mpF" value="3d687654-ce51-492e-82ac-5898fafc23a3" />
      <property role="T9mpE" value="translator.devkit" />
    </node>
    <node concept="1QGGSu" id="7FyuF1ogtDr" role="3vqPLo">
      <property role="1iqoE4" value="${module}/icons/translatorModel.png" />
    </node>
  </node>
</model>
